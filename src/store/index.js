...
export function hospitalLogin(input) {
    return (dispatch) => {
        fetch('http://192.168.1.71:3000/hospital/login', {
            method: 'POST',
            headers: {
...
export function addPatient(input) {
    ...
    return (dispatch) => {
        console.log(input)
        fetch('http://192.168.1.71:3000/hospital/add', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
...
export function getProfile() {
    ...
    return (dispatch) => {
        console.log('1')
        fetch('http://192.168.1.71:3000/hospital', {
            method: 'get',
            headers: {
                access_token: access_token
            }
...
export function getPatients() {
    ...
    return (dispatch) => {
        fetch( `http://192.168.1.71:3000/hospital/patients`, {
            method: 'GET',
            headers: {
                access_token: access_token
            }
...
export function getPatientRecords(params) {
    ...
    return (dispatch) => {
        fetch(`http://192.168.1.71:3000/hospital-record/${params}`, {
            method: 'GET',
            headers: {
                access_token: access_token
            }
...
export function createRecord(input) {
    ...
    console.log(input)
    return (dispatch) => {
        fetch('http://192.168.1.71:3000/hospital-record', {
            method: 'post',
            headers: {
                access_token: access_token,
                'Content-Type': 'application/json'
